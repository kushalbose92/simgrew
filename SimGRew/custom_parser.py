...
def argument_parser():
    ...
    parser.add_argument('--val_lr', help = 'validation learning rate', default = 0.2, type = float)
    ...
    parser.add_argument('--de_lambda', help = 'value of lambda for DE regularizer', default= 0.0001, type = float)
    ...
    parser.add_argument('--val_w_decay', help = 'Weight decay for the validation optimizer', default = 0.0005, type = float)
