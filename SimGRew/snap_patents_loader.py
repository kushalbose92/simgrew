...
def load_snap_patents_mat(nclass=5):
    ...
    # train_mask = mask_generation(train_idx, dataset.graph['num_nodes'])
    # val_mask = mask_generation(val_idx, dataset.graph['num_nodes'])
    # test_mask = mask_generation(test_idx, dataset.graph['num_nodes'])
...
# h_e = homophily(data.edge_index, data.y, method='node')
# print(h_e)

# splits_lst = load_fixed_splits('snap-patents', None)
# print(splits_lst)
...
# print(split_idx['train'].shape, "\t", split_idx['valid'].shape, "\t", split_idx['test'].shape)