...
from snap_patents_loader import *
...
def train(train_loader, test_loader, model, opti_train, opti_val, de_lambda, train_iter, model_path, device):
    ...
    plt.savefig("prob_de_vals_snap-patents.png")
    plt.close()
...
for run in range(num_steps):
    ...
    #     print(i, "  ", data)
    test_loader = RandomNodeLoader(dataset, num_parts = num_parts, shuffle = True, num_workers=5)
